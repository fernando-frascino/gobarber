...
- Pada atualizar sua senha, o usuário prefisa confirmar a nova senha;
...
- As notificações do prestados devem ser armazenadas no MongoDB;
- As notificações do prestador devem ser enviadas em tempo-real utilizando Sovket.io;
